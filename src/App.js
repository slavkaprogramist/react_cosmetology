  ...
  return (
    <div className="wrapper clear">
      ...
      <header className="align-center">
        ...
        <ul className = "d-flex ">
          <li className = "mr-30 header-item">
            <a className="text-uppercase" href="index.html">Медичний центр</a>
          </li>
          <li className = "mr-30 header-item">
            <a className="text-uppercase" href="index.html">каталог товарів</a>
          </li>
          <li className = "mr-30 header-item">
            <a className="text-uppercase" href="index.html">каталог послуг</a>
          </li>
          <li className = "mr-5">
